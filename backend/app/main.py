...
from app.api.restock_requests import router as restock_requests_router
...
app.include_router(restock_requests_router, prefix="/restock-requests", tags=["Restock Requests"])
